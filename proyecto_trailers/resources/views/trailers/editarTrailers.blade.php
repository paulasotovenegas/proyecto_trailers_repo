        ...
        <div class="row">
            ...
            <div class="col-lg-5 col-md-6 col-sm-12">
                <ul class="breadcrumb float-md-right">
                    ...
                    <li class="breadcrumb-item active">Editar Trailer</li>
                </ul>
            </div>
        </div>
    </div>
    <div class="container-fluid">
        ...
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12">
                <div class="card">
                    <div class="header">
                        <h2><strong>Editar Trailer</strong> </h2>                        
                    </div>
                    <div class="body">
                        @if (session('success'))
                        ...
                        @endif
                            <form id="trailers" method="POST" action="{{route('trailers.update',$item->id_trailer)}}">
                                @csrf
                        <h2 class="card-inside-title">Información de los Trailers</h2>
                        <div class="row clearfix">
                            <div class="col-sm-12">
                                <div class="form-group">                                    
                                    <input type="text" readonly class="form-control date" placeholder="Placa de Tráiler" name="placaTrailer" value="{{$item->placaTrailer}}" />
                                    @error('placaTrailer')
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="date" name="tarjetaPesosDimensiones" class="form-control date" value="{{$item->tarjetaPesosDimensiones}}" placeholder="Tarjeta de Pesos y Dimensiones, eje: 30/07/2016">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="date" name="riteve" class="form-control date" value="{{$item->riteve}}" placeholder="Riteve, eje: 30/07/2016">
                                    @error('riteve')
                                    <div class="alert alert-danger" role="alert">
                                    <strong>{{ $message }}</strong>
                                        </div>
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="date" name="marchamo" class="form-control date" value="{{$item->marchamo}}" placeholder="Marchamo, eje: 30/07/2016">
                                    @error('marchamo')
                                    <div class="alert alert-danger" role="alert">
                                    <strong>{{ $message }}</strong>
                                        </div>
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="date" name="tarjetaTransportePeligroso" class="form-control date" value="{{$item->tarjetaTransportePeligroso}}"  placeholder="Tarjeta de Transporte Peligroso, eje: 30/07/2016">
                                    ...
                                    <div class="form-group">                                    
                                        <input type="text" class="form-control date" placeholder="Código de Transportista" name="codigoTransportista" value="{{$item->codigoTransportista}}" />
