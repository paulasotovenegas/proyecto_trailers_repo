    ...
    <div class="container-fluid">
        ...
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12">
                <div class="card">
                    <div class="header">
                        <h2><strong>Editar Reparación</strong> </h2>                        
                    </div>
                    <div class="body">
                        @if (session('success'))
                ...
                @endif
                <form id="reparaciones" method="POST" action="{{route('reparaciones.update',$item->id_reparacion)}}">
                        @csrf
                        ...
                        <div class="row clearfix">
                            <div class="col-sm-12">
                                ...
                                <div class="form-group">
                                    <input type="text" name="descripcionReparacion" value="{{$item->descripcionReparacion}}" class="form-control" placeholder="Descripción de la Reparación" />
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="date" name="fechaReparacion" onchange="calcular()" id="fechaReparacion" value="{{$item->fechaReparacion}}" class="form-control date" placeholder="Fecha de Reparación, eje: 30/07/2016">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="date" name="fechaDano" onchange="calcular()" id="fechaDano" value="{{$item->fechaDano}}" class="form-control date" placeholder="Fecha de Daño, eje: 30/07/2016">
                                    @error('fechaDano')
                                    <div class="alert alert-danger" role="alert">
                                    <strong>{{ $message }}</strong>
                                        </div>
                                ...
                                <div class="form-group">
                                    <input type="text"  name="observaciones" value="{{$item->observaciones}}" class="form-control" placeholder="Observaciones" />
                                    @error('observaciones')
                                    <div class="alert alert-danger" role="alert">
                                    <strong>{{ $message }}</strong>
                                        </div>
                                ...
                                <div class="input-group">
                                    ...
                                    <div class="form-group">
                                        <input type="text" name="duracion" id="duracion" value="{{$item->duracion}}" class="form-control" placeholder="Duración" readonly />
                                        @error('duracion')
                                        <div class="alert alert-danger" role="alert">
                                        <strong>{{ $message }}</strong>
                                            </div>
