    ...
    <div class="container-fluid">
        ...
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12">
                <div class="card">
                    <div class="header">
                        <h2><strong>Editar Ruta</strong> </h2>                        
                    </div>
                    <div class="body">
                        @if (session('success'))
                        ...
                        @endif
                        <form id="rutas" method="POST" action="{{route('ruta.update',$item->id_ruta)}}">
                            @csrf
                            @method('PUT')
                        ...
                        <div class="row clearfix">
                            <div class="col-sm-12">
                                <div class="form-group">
                                    <input type="text" class="form-control" placeholder="Descripción de la Ruta" name="descripcionRuta" value="{{$item->descripcionRuta}}" />
