    ...
    <div class="row">
        ...
        <div class="col-lg-5 col-md-6 col-sm-12">
            <ul class="breadcrumb float-md-right">
                ...
                <li class="breadcrumb-item"><a href="javascript:void(0);">Ingresar Empleados </a></li>
...
<div class="container-fluid">
    ...
    <div class="row clearfix">
        <div class="col-lg-12 col-md-12 col-sm-12">
            <div class="card">
                <div class="header">
                    <h2><strong>Ingresar Empleados</strong> </h2>
                </div>
                <div class="body">
                @if (session('success'))
                ...
                @endif
                    <form id="empleados" method="POST" action="{{route('empleado.store')}}">
                        @csrf
                            ...
                            <div class="col-sm-12">
                                ...
                                <div><br>
                                    ...
                                    <select name="tipoLicencia" class="form-control show-tick"> 
                                        ...
                                        <option value="Licencia B4 (camión articulado)">Licencia B4 (Camión Articulado)</option>
                                ...
                                <div>
                                    <h2 class="card-inside-title">Fecha de Vencimiento de Licencia</h2>
                                    </div>
                                <div class="input-group">

                                    <span class="input-group-addon"><i class="zmdi zmdi-calendar"></i> </span>
                                    
                                    <input type="date" name="fechaVencimientoLicencia" class="form-control date" placeholder="Fecha de Vencimiento de Licencia, eje: 30/07/2016">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="date" name="fechaNacimiento" class="form-control date" placeholder="Fecha de Nacimiento, eje: 30/07/2016">
                                ...
                                <div class="form-group">
                                    <input type="number" name="numeroCedula" class="form-control" placeholder="Número de Cédula" value="{{old('numeroCedula')}}"/>
                                    @error('numeroCedula')
                                    <div class="alert alert-danger" role="alert">
                                    <strong>{{ $message }}</strong>
                                        </div>
                                ...
                                <h2 class="card-inside-title">Otras Señas</h2>
                                <div class="form-group">
                                    <input type="text" name="otrasReferencias" class="form-control" placeholder="Otras Señas" value="{{old('otrasReferencias')}}"/>
                                ...
                                <h2 class="card-inside-title">Número de Teléfono</h2>
                                <div class="input-group">
                                    <span class="input-group-addon"><i class="zmdi zmdi-smartphone"></i></span>
                                    <input type="number" name="numeroTelefono" class="form-control mobile-phone-number" placeholder="Número de Teléfono" value="{{old('numeroTelefono')}}">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="email" name="email" class="form-control email" placeholder="Email, eje: ejemplo@ejemplo.com" value="{{old('email')}}" >
                                    @error('email')
                                    <div class="alert alert-danger" role="alert">
                                    <strong>{{ $message }}</strong>
                                        </div>
                    ...
                    provinciaSelect.addEventListener("input", () => {
                        ...
                        fetch('/provincia/select', {
                            ...
                            .then(response => {
                                ...
                                console.log(document.querySelector("#provincia").value);
                            })
                    });
                    ...
                    cantonSelect.addEventListener("input", () => {
                        ...
                        fetch('/canton/select/api', {
                            ...
                            .then(response => {
                                ...
                                console.log(document.querySelector("#canton").value);
                            })
                    });
